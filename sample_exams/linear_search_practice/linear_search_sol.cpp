...
int linearSearch(int arr[], int size, int target)
{
    ...
    return -1; // Went through the whole array and found nothing
}
...
bool isNameInList(const std::vector<std::string>& names, std::string target)
{
...
std::vector<int> findAllIndices(int arr[], int size, int target)
{
...
std::string findStudentById(Student students[], int size, int targetId)
{
    for (int i = 0; i < size; i++)
    {
